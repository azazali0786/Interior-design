...
// tiny helper to create an inline SVG data URL used as a lightweight blur placeholder
const toBase64 = (str: string) =>
  typeof window === 'undefined' ? Buffer.from(str).toString('base64') : window.btoa(str)
const svgToDataURL = (w = 16, h = 10, fill = '#f3f4f6') => {
  const svg = `<svg xmlns='http://www.w3.org/2000/svg' width='${w}' height='${h}' viewBox='0 0 ${w} ${h}'><rect width='100%' height='100%' fill='${fill}'/></svg>`
